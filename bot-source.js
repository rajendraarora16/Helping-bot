...
function sportRajendra(){
	var botMsg = "<div class='chat-message clearfix'>"
		...
		+"<span class='chat-time'>"+currentTime()+"</span>"
		+"<h5>Rajendra's Bot</h5>"
		+"<p class='chat-msg_'>Rajendra loves football. Sometimes he used to play. <br/>Don't have much information about sports as he usually spend mostly time in front of computer.</p>"
		+"<hr>"
...
function experienceRajendra(){
	var botMsg = "<div class='chat-message clearfix'>"
		...
		+"<span class='chat-time'>"+currentTime()+"</span>"
		+"<h5>Rajendra's Bot</h5>"
		+"<p class='chat-msg_'>Currently Rajendra has overall 1.5 years of experience from Bookmyshow's organisation. <br/><br/>He is loving to work with Bookmyshow. <br/>Rajendra is involved with much more technologies like phantomjs (His favourite but now Chrome blink with headless), Node.js, Javascript, Java, JSP/Servlets, html, css, React.js, Redux etc.</p>"
		+"<hr>"
